  ...
  <header class="glass-nav">
    <div class="header-container flex-between">
      <a href="[[PREFIX]]index.html" class="logo group">
        <img src="[[PREFIX]]assets/images/app_logo.png" alt="Toolsathi Logo" width="32" height="32" class="flex-shrink-0 cursor-pointer hover:opacity-80 transition-opacity" style="border-radius: 0.25rem;" loading="lazy" onerror="this.onerror=null; this.outerHTML='<span style=\\'display:flex; width:32px; height:32px; align-items:center; justify-content:center; background:var(--accent-violet); color:white; border-radius:0.25rem; font-weight:bold;\\'>T</span>'" />
